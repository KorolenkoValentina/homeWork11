...
function generatePermutations<T>(arr: T[]): T[][] {
 ...
 function permute(remainingElem: T[],  currentPerm: T[] = []) {
   ...
   for (let i = 0; i < remainingElem.length; i++) {
     // const newСurrentPerm = [...currentPerm, remainingElem[i]];
     // const newRemainingElem = [...remainingElem.slice(0, i), ...remainingElem.slice(i + 1)];
     // permute(newRemainingElem, newСurrentPerm);
